...
export function ScreenshotProtection({ children, onScreenshotAttempt }: ScreenshotProtectionProps) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (isPrintScreen || isCtrlShiftI || isF12 || isCtrlShiftC || isCtrlU || isCtrlS) {
        e.preventDefault()
        onScreenshotAttempt()
      }
    }
