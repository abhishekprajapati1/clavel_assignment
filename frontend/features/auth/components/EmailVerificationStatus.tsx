    ...
    switch (status) {
      ...
      case 'success':
        return {
          ...
          description: message || 'Your email has been verified. You can now sign in to your account.',
          variant: 'default' as const,
          showActions: true,
      ...
      case 'error':
        return {
          ...
          description: error || 'We couldn\'t verify your email. The link may be invalid or expired.',
      ...
      case 'expired':
        return {
          ...
          description: 'Your verification link has expired. We can send you a new one.',
          variant: 'default' as const,
          showActions: true,
          actionType: 'resend' as const,
        }
      case 'invalid':
        return {
          ...
          description: 'The verification link is invalid. Please check the link or request a new one.',
          variant: 'destructive' as const,
          showActions: true,
          actionType: 'resend' as const,
        }
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-500 mt-6">
              <p>Need help? <a href="/contact" className="text-blue-600 hover:text-blue-500">Contact support</a></p>
            </div>
          </CardContent>
        </Card>
      </div>
